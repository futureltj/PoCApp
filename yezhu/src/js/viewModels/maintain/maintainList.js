    ...
    function (oj, ko, $, tfcommon, mbe) {
        ...
        function DashboardViewModel() {
            ...
            */
            ...
            self.getPicBase64ById = function (id) {
                console.log('localStorage.getItem:' + id + '====' + localStorage.getItem('pic' + id))
                var picstr = localStorage.getItem('pic' + id);
                if (picstr != undefined && picstr != '' && picstr != null) {
                    return picstr;
                } else {
                    return '';
                }
            }
            self.isArrayContainObj = function (arr, val) {
            ...
            self.updateTaskImage = function (t) {
                var picstr = self.getPicBase64ById(t.pic);
                //console.log('picstr=' + picstr.length);
                if (picstr.length > 0) {
                    t.attr5 = picstr;
                    //console.log('from cache:' + JSON.stringify(t));
                    if(!self.isArrayContainObj(self.data(),t))
                        self.data.push(t);
                } else {
                    mbe.getStorageObjectFromCollection('PicCollection', t.pic, function (obj) {
                        ...
                        self.blobToBase64(rawData, function (base64) {
                            ...
                            localStorage.setItem('pic' + t.pic, t.attr5);
                            //console.log('from server:' + JSON.stringify(t));
            ...
            self.getTaskList = function () {
                ...
                */
                tfcommon.get('listTasks', {}, function (data) {
                    self.data.removeAll();
                    var arr = new Array();
