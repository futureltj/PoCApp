 ...
 * Oracle Mobile Cloud Service JavaScript SDK for Cordova, Release: 17.4.5.0, E89276-01
*/
...
function Notifications(backend, utils, platform, logger) {
  ...
  this.registerForNotifications = function(deviceToken, appId, appVersion, successCallback, errorCallback) {
    ...
    var _platform = typeof device == "undefined" ? this.getDevicePlatform() : device.platform.toUpperCase();
    var payload = {
      "notificationToken": deviceToken,
      "notificationProvider": _platform === 'ANDROID' ? 'GCM' : 'APNS',
      "mobileClient": {
        "id": appId,
        "version": appVersion,
        "platform": _platform
